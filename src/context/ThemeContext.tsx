...
export const THEMES: Record<ThemeId, Theme> = {
  ...
  sunset: {
    ...
    name: 'Sunset',
    colors: {
      accentPrimary: '#e89858',
      accentPrimaryHover: '#f0b078',
      accentPrimaryDim: 'rgba(232,152,88,0.18)',
      accentPrimaryGlow: 'rgba(232,152,88,0.45)',
      accentSecondary: '#d47868',
      accentWarm: '#f0c878',
      bgDeepest: '#16100c',
      bgDeep: '#201510',
      bgSurface: '#2c1e16',
      ...
      bgElevated: '#4c3830',
      borderSubtle: '#402c1e',
      borderDefault: '#58422c',
      borderStrong: '#70543c',
      textPrimary: '#f5e8d8',
      textSecondary: '#c8b098',
      textTertiary: '#9a8060',
      textMuted: '#7a6048',
    },
  },
